...
function guardar (){
    ...
    var horaDigita = document.getElementById('Digita').value;
    var horaAcopio = document.getElementById('Acopio').value;
    var horaRevisa = document.getElementById('Revisa').value;
...
db.collection("bdTiempos").onSnapshot((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
        ...
        tabla.innerHTML += `
        <tr>
        <!--hora Revision final Receta <th scope="row">${doc.id}</th>  esto esta comentado para que no aparezca -->
        ...
        <td><button class="btn btn-danger btn-fab btn-fab-mini btn-round" onclick="eliminar('${doc.id}')">
        <i class="material-icons">
        delete_forever</i>
      </button></td>
        
        <td><button class="btn btn-warning btn-fab btn-fab-mini btn-round" onclick="editar('${doc.id}','${doc.data().FechaActual}','${doc.data().Ebais}','${doc.data().Receta}','${doc.data().FechaReceta}','${doc.data().HoraEntra}')">  <i class="material-icons">
        edit</i>
        </button></td>
        </tr>        
